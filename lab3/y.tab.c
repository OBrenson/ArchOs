...
static const char *const yytname[] =
{
  ...
  "ERROR", "SIGN", "$accept", "b", "beg", "sign", "symbols", "symbol",
  "begin", "sym_letter", "sym_digit", "ending", YY_NULLPTR
};
#endif
